...
def build(bld):
    ...
    module.source = [
        ...
        'model/satellite-leo-net-device.cc',
        'model/satellite-leo-user-phy.cc',
        ...
        'helper/satellite-leo-helper.cc',
    ...
    headers.source = [
        ...
        'model/satellite-leo-net-device.h',
        'model/satellite-leo-user-phy.h',
