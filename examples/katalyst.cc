...
/*
 *
 * Author: Ozgur Ural <uralo@my.erau.edu>
 *
 */
 ...
 *        This is a multicast example application to test multicasting in satellite network.
...
int main (int argc, char *argv[])
{
  ...
  LogComponentEnable ("katalyst", LOG_LEVEL_INFO);

  NS_LOG_INFO ("--- Starting katalyst ---");
  ...
  uint32_t fullScenarioReceivers = 2;
 ...
 Ptr<Node> groupSource;
  ...
  AnimationInterface anim ("katalyst.xml");
