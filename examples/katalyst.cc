...
main (int argc, char *argv[])
{
  ...
  Ptr<SimulationHelper> simulationHelper = CreateObject<SimulationHelper> ("katalyst");
  ...
  std::string outputPath = Singleton<SatEnvVariables>::Get ()->LocateDirectory ("contrib/satellite/data/sims/katalyst");
